    ...
    public class SpatialButton : SpatialTouchable
    {
        ...
        private void TouchStart(Toucher toucher)
        {
            ...
            if (playHapticFeedbackOnToucher && toucher != null)
            {
                ...
                var hardwarehand = toucher.gameObject.GetComponentInParent<IHardwareHand>();
                if (feedbackHandler != null && hardwarehand != null && hardwarehand is IHapticFeedbackProviderRigPart hapticProvider)
                {
                    
                    feedbackHandler.PlayHapticFeedback(hapticAmplitude:toucherHapticAmplitude, hardwareRigPart: hapticProvider, hapticDuration: toucherHapticDuration);
                }
            }
        }
