...
- Version 2.1.1: Compatibility with Fusion 2.1
- Version 2.1.0: Update to support new XRShared architecture
- Version 2.0.11:
  - Fix StreamSynchedBehaviour detection of busy late joiners recovery data sender
  - Fix audio feedback triggering on CameraPicture
  - Add security to avoid duplicate download of data send just after a player connection (while they were downloading data present in the room before their connection)
- Version 2.0.10:
  - Fix to StreamSynchedBehaviour to avoid cases where a late joiner state could be mistakenly detected, leading to request data that where already incoming
- Version 2.0.8:
